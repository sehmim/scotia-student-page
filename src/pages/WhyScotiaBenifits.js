        ...
        return (
            <div id="why-scotia2" className="why-scotia2">
                <Box className="para-body" m={3} alignLeft>
                    <Typography style={{ fontWeight: '400', paddingBottom: '20px', color: "white", fontSize: '250%' }} align="left" variant="h1" component="h1"> Pay and Benefits </Typography>
                    <Box mb={3.0}>
                        <Box mb={3.0}>
                        ...
                        <Typography style={{ fontWeight: '400', paddingBottom: '20px', color: "white", fontSize: '250%' }} align="left" variant="h1" component="h1"> Responsibilities </Typography>
                        <Box mb={3.0}>
                        ...
                        <Typography style={{ fontWeight: '400', paddingBottom: '20px', color: "white", fontSize: '250%' }} align="left" variant="h1" component="h1"> Opportunities </Typography>
                        <Box mb={3.0}>
                            <Typography style={{ fontWeight: '400', color: "white" }} align="left" variant="subtitle1" component="h5">
